      ...
      <div class="container-fluid" style="margin-top: 35px;">
        <div class="row">
          <div class="col-md-3">
            ...
            <div class="col-md-9">
              <h1>Users Infromation</h1>
              <table class="table table-boardered table-dark table-striped table-hover">
                <thead class="thead ">
                  <th>UserID</th>
                  <th>First Name</th>
                  <th>Last Name</th>
                ...
                <tbody >
                  ...
                  <td><?php echo $d;?></td>
                  <td><?php echo $e;?></td>
                  <td> <a href="edit.php?id=<?php echo $a; ?> &fname=<?php echo $b; ?> &lname=<?php echo $c; ?>&username=<?php echo $d;?> &password=<?php echo $e; ?>" class="btn btn-primary">Edit</a></td>
